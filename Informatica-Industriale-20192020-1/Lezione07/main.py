  ...
  def getData(self, sourceList):
    if self.automa.getStateName() == 'READY':
      ...
      for source in sourceList:
        self.data.append(source.getData(self.pos))
    return self.data
...
for t in range(200):
  ...
  valori1.append(data[0])
  valori2.append(data[1])
  valori3.append(data[2])
  valori4.append(data[3])
  x += 1
  y += 0
  pos = Pos(x, y)
  sensore.setPos(pos)
...
ax.plot(tempi, valori1)
ax.plot(tempi, valori2)
ax.plot(tempi, valori3)
ax.plot(tempi, valori4)
